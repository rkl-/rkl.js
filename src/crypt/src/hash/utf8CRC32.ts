...
{
	/**
	 * CRC32 Prüfsumme eines UTF-8 Strings berechnen
	 * 
	 * @pram str String dessen Prüfsumme berechnet werden soll
	 * @return number
	 */
	export function utf8CRC32(str: string) {
		var table: any = ""
